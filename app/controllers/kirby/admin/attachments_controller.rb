module Kirby
  module Admin
    class AttachmentsController < AdminController
      ...
      def index
        add_breadcrumb I18n.t('kirby.website.documents'), kirby.admin_attachments_path
      ...
      def destroy
        ...
        @attachment.destroy
        redirect_to kirby.admin_attachments_url
      end
      ...
      def set_breadcrumbs
        add_breadcrumb I18n.t('kirby.website.media_library'), kirby.admin_media_library_path
      end
